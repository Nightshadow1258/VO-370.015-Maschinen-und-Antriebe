...
\begin{equation}
n(M_i) = \frac{U_A - R_A \frac{2 M_i}{k^{'} \Phi}}{k^{'}\Phi} \cdot 2 \cdot \frac{60}{2 \pi} =6000-0,188 \cdot M_i
\end{equation}
...
\begin{align}
U_A &= R_E \cdot  I_E =  - I_E \cdot R_A + k^{'} \phi \cdot \Omega_m\\
k^{'} \phi \cdot \Omega_m &= (R_E + R_A) \cdot I_E\\
\frac{k_1 \phi}{I_E} &= \frac{R_E +R_A}{\Omega_N}\cdot 2 \pi = 0,901
\end{align}
Eine Gerade mit der Steigung $0,901$ einzeichnen und bei dem Schnittpunkt ablesen. $I_E \approx 7~A$ und $R_E \cdot I_E \approx 315~V$.
\end{compactenum}
\end{solution}